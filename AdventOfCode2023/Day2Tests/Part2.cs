...
Game 5: 6 red, 1 blue, 3 green; 2 blue, 1 red, 2 green";
            ...
            //var expectedPowers = new List<Dictionary<string, int>>
            //{
            //    new Dictionary<string, int>() { { "red", 4 }, { "green", 2 }, { "blue", 6 } },
            //    new Dictionary<string, int>() { { "red", 1 }, { "green", 3 }, { "blue", 4 } },
            //    new Dictionary<string, int>() { { "red", 20 }, { "green", 13 }, { "blue", 6 } },
            //    new Dictionary<string, int>() { { "red", 14 }, { "green", 3 }, { "blue", 15 } },
            //    new Dictionary<string, int>() { { "red", 6 }, { "green", 3 }, { "blue", 2 } }
            //};
        ...
        {
            var input = @"Game 1: 19 blue, 12 red; 19 blue, 2 green, 1 red; 13 red, 11 blue
